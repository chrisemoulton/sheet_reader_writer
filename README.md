...
```bash
GOOGLE_CLIENT_EMAIL="exampleserviceaccount@example.iam.gserviceaccount.com"
...
puts result
```
which returns an array of hashes, where each hash rerpesents a row keyed by the column names found in the first row of the spreadsheet:
